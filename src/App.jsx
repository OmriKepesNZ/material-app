...
// ── CommentSection — defined outside GsReviewModal to prevent re-render focus loss ──
function CommentSection({ label, rows, setter, sKey, addRow, updateText, removeRow,
